...
Основные домены - mail.goolge.com, gmail.com
...
Для балансировки воходящих забросов будет использоваться Nginx и DNS. Nginx должен раз в 1 секунду обновлять балансировки DNS на сдучай выхода их строя одного из серверов.

### Балансировка межсервисных запросов

Для балансировки межсервисных запросов будет использоваться схема с двумя балансировщиками - для внешнего и для внутреннего трафика.
