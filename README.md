...
| Nginx | VRRP |
| LVS | VRRP |
| Датацентр | Разделение на 12 зон доступности (6 основных, 6 резервных) |

## 10. Схема проекта (в разработке)

![image](https://github.com/user-attachments/assets/f485ee67-5b5c-4913-abe9-c8555d8331da)
