...
Для балансировки воходящих забросов будет использоваться балансировщик L7 - Nginx и DNS для service discovery. Nginx должен раз в 1 секунду обновлять DNS на сдучай выхода из строя одного из серверов.
