...
Для балансировки входящих забросов будет использоваться балансировщик L7 - Nginx и DNS для service discovery. Nginx должен раз в 1 секунду обновлять DNS на сдучай выхода из строя одного из серверов.
...
Для терминации SSL при рассчитанном RPS понадобятся 3.5M / 10K[20] = 350 Серверов.

## 5. Логическая схема БД

![image](https://github.com/user-attachments/assets/ec593dea-8609-4155-a057-fcfa29a73589)
